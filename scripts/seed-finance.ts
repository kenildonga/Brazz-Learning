...
const VIDEOS: VideoSeed[] = [
  ...
  },
  {
    ...
    duration: 960,
    description:
      'Using a primary residence to offset housing costs and start investing in property.',
...
const seed = async () => {
  ...
  console.log(
    `Influencers: ${influencerCounts.inserted} inserted, ${influencerCounts.updated} updated`,
  );
